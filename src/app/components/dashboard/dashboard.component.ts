...
import { ColorType, DeepPartial, TimeChartOptions, createChart } from 'lightweight-charts';
...
export class DashboardComponent implements AfterViewInit {
  ...
  getChart(){
    let chart = createChart(this.firstChart!.nativeElement, this.chartOptions);
    console.log("document?: ", this.firstChart!.nativeElement)
